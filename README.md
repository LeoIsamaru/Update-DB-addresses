Created in 2022 using AutoHotkey (AHK), this program automates updates to a specific database (DB) for an employee who doesn't have direct access to it due to restrictions associated with their position.
